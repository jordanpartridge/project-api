            ...
            <div class="px-4 mx-auto max-w-7xl sm:px-6">
                <div class="text-center">
                    ...
                    <p class="max-w-md mx-auto mt-3 text-base text-slate-300 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                        The ultimate solution for managing GitHub projects, repositories, and documentation. Built with
                        Laravel, enhanced with real-time capabilities.
                    </p>
                    <div class="max-w-md mx-auto mt-5 sm:flex sm:justify-center md:mt-8">
                        <div class="rounded-md shadow">
                            <a href="/docs"
                               class="flex items-center justify-center w-full px-8 py-3 text-base font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 md:px-10 md:py-4 md:text-lg">
                                View Documentation
                            </a>
                        </div>
                    </div>
